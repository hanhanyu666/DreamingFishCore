...
public class Packet_CheckResultRequest {
    ...
    public static void handle(Packet_CheckResultRequest msg, Supplier<NetworkEvent.Context> contextSupplier) {
        ...
        context.enqueueWork(() -> {
            ...
            DreamingFishCore_NetworkManager.INSTANCE.send(PacketDistributor.PLAYER.with(() -> target), new Packet_CheckResultResponse(msg.playerName, msg.playerUUID, msg.senderName, msg.senderUUID, msg.actionType, msg.result));
        });
