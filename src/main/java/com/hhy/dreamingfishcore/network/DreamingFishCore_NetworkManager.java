...
public final class DreamingFishCore_NetworkManager {
    // 任务地点状态标签和边界提示加入网络契约，旧客户端应在握手时明确拒绝连接。
    ...
    private static void registerPayloadHandlers(RegisterPayloadHandlersEvent event) {
        ...
        registrar.playToServer(Packet_EquipPlayerRank.TYPE, Packet_EquipPlayerRank.STREAM_CODEC, Packet_EquipPlayerRank::handle);
